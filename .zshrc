# See CHANGE for my modifications
# See MINE for my additions
...
bind2maps emacs viins       -- -s '^f.' zleiab
#k# Display list of abbreviations that would expand
bind2maps emacs viins       -- -s '^fb' help-show-abk
#k# mkdir -p <dir> from string under cursor or marked area
bind2maps emacs viins       -- -s '^fM' inplaceMkDirs
#k# display help for keybindings and ZLE
bind2maps emacs viins       -- -s '^fz' help-zle
#k# Insert files and test globbing
bind2maps emacs viins       -- -s "^ff" insert-files
#k# Edit the current line in \kbd{\$EDITOR}
bind2maps emacs viins       -- -s '\ee' edit-command-line
#k# search history backward for entry beginning with typed text
bind2maps emacs viins       -- -s '^fp' history-beginning-search-backward-end
#k# search history forward for entry beginning with typed text
bind2maps emacs viins       -- -s '^fP' history-beginning-search-forward-end
#k# search history backward for entry beginning with typed text
bind2maps emacs viins       -- PageUp history-beginning-search-backward-end
#k# search history forward for entry beginning with typed text
bind2maps emacs viins       -- PageDown history-beginning-search-forward-end
bind2maps emacs viins       -- -s "^f^h" commit-to-history
...
bind2maps emacs viins       -- -s '^f1' jump_after_first_word
#k# complete word from history with menu
bind2maps emacs viins       -- -s "^f^f" hist-complete
...
function prompt_grml_precmd () {
    ...
    left_items=(rc change-root path vcs percent)
...
alias sshserver='ssh -p 55443 dan@rschrader.xyz'
